%% Compute EEG band power using EEGLAB spectopo
% This script loads an EEGLAB .set file, computes channel-level spectra using
% EEGLAB's spectopo function, and estimates mean power in canonical frequency
% bands [delta, theta, alpha, beta, gamma (30-80Hz)]
%
% Part of the frequency-band extraction workflow is based on standard
% EEGLAB spectopo examples and EEGLAB mailing-list guidance.
%
% References:
%   EEGLAB spectopo documentation:
%   https://sccn.ucsd.edu/~arno/eeglab/auto/spectopo.html
%
%   EEGLAB mailing list example on computing frequency-band power:
%   https://sccn.ucsd.edu/pipermail/eeglablist/2015/008910.html

[ALLEEG EEG CURRENTSET ALLCOM] = eeglab; % open eeglab

%load dataset
EEG = pop_loadset('filename','eeglab_data.set','filepath','\path\to\data');
